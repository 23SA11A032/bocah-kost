                        ...
                        >
                            <Sidebar.Items>
                                <Sidebar.ItemGroup>
                                    ...
                                    <Sidebar.Item className={path == "/admin/admin/admin-pengaturan" && "bg-gray-100 dark:bg-gray-700"} as={Link} href={"/admin/admin/admin-pengaturan"} icon={HiCog}>
                                        Pengaturan Admin
                                    </Sidebar.Item>
                                    <Sidebar.Item
                                        className={path == "/admin/admin/admin-verifikasi-kost" && "bg-gray-100 dark:bg-gray-700"}
                                        as={Link}
                                        href={"/admin/admin/admin-verifikasi-kost"}
