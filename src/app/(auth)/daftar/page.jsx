...
const schema = object({
    nama: string().min(5).required().label("Nama"),
    jk: mixed().oneOf(["Laki-Laki", "Perempuan"]).defined().label("Jenis Kelamin"),
    pekerjaan: string().required().label("Pekerjaan"),
    status: mixed().oneOf(["Sudah Menikah", "Belum Menikah"]).defined().label("Status"),
    alamat: string().required().label("Alamat"),
    nowa: string().min(10).label("Nomor Whatsapp"),
                ...
                <Card className="max-w-sm lg:max-w-lg w-full relative shadow-lg overflow-hidden">
                    ...
                    {!role && (
                        <div className={`duration-100`}>
                            <h5 className="text-2xl font-bold tracking-tight pl-10 text-gray-900 dark:text-white">Mau Jadi Apa?</h5>
                            ...
                            <p className="pt-5 font-medium text-gray-500 dark:text-gray-300 text-right">
                                Sudah punya akun?{" "}
                                <Link className="text-cyan-700 hover:underline dark:text-cyan-500" href={"/"}>
                                    Masuk
                                </Link>{" "}
                            </p>
                        </div>
                    ...
                    {role && (
                        <div className={`duration-100`}>
                            <h5 className="flex flex-row gap-3 items-center text-2xl font-bold tracking-tight text-gray-900 dark:text-white -translate-x-[0%] duration-700">
                                ...
                                <div>
                                    Daftar
                                    <span className="text-lg bg-gradient-to-r from-teal-700 to-teal-400 bg-clip-text text-transparent pl-4">{` ${role == "user" ? "Pencari Kost" : "Pemilik Kost"}`}</span>
                                </div>
                            </h5>
                            ...
                            <form className="flex flex-col gap-4 mt-6" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <TextInput id="nama" {...register("nama")} placeholder="nama" helperText={errors.nama?.message} color={errors.nama?.message && "failure"} />
                                    </div>
                                    <div>
                                        <div className="mb-2">
                                            <Label htmlFor="jk" value="Jenis Kelamin" />
                                        </div>
                                        <Select id="jk" defaultValue={""} {...register("jk")} helperText={errors.jk?.message} color={errors.jk?.message && "failure"}>
                                ...
                                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-2`}>
                                    <div>
                                        ...
                                        <TextInput id="nowa" {...register("nowa")} helperText={errors.nowa?.message} color={errors.nowa?.message && "failure"} placeholder="nomor whatsapp" />
                                    </div>
                                    <div>
                                        <div className={`mb-2`}>
                                            <Label htmlFor="pekerjaan" value="Pekerjaan" />
                                        </div>
                                        <TextInput id="pekerjaan" {...register("pekerjaan")} helperText={errors.pekerjaan?.message} color={errors.pekerjaan?.message && "failure"} placeholder="pekerjaan" />
                                    </div>
                                </div>
                                ...
                                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-2`}>
                                    <div>
                                        ...
                                        <Select defaultValue={""} id="status" {...register("status")} helperText={errors.status?.message} color={errors.status?.message && "failure"}>
                                            <option value="" disabled>
                                                pilih
                                            </option>
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="alamat" {...register("alamat")} helperText={errors.alamat?.message} color={errors.alamat?.message && "failure"} placeholder="alamat" />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <TextInput id="email" {...register("email")} helperText={errors.email?.message} color={errors.email?.message && "failure"} placeholder="email" />
                                    </div>
                                    <div>
                                        <div className="mb-2">
                                            <Label htmlFor="pass" value="Password" />
                                        </div>
                                        <TextInput id="pass" {...register("password")} helperText={errors.password?.message} color={errors.password?.message && "failure"} type="password" placeholder="password" />
                                    </div>
                                </div>
