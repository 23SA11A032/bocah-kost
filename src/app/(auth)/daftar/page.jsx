...
const schema = yup.object({
    ...
    jk: yup.mixed().oneOf(["Laki-Laki", "Perempuan"]).defined().label("Jenis Kelamin"),
    pekerjaan: yup.string().required().label("Pekerjaan"),
    status: yup.mixed().oneOf(["Sudah Menikah", "Belum Menikah"]).defined().label("Status"),
                            ...
                            <h5 className="flex flex-row gap-3 items-center text-2xl font-bold tracking-tight text-gray-900 dark:text-white -translate-x-[0%] duration-700">
                                ...
                                <div>
                                    ...
                                    <span className="text-lg bg-gradient-to-r from-teal-700 to-teal-400 bg-clip-text text-transparent pl-4">{` ${
                                        role == "user" ? "Pencari Kost" : "Pemilik Kost"
                                    }`}</span>
                                </div>
                            </h5>
                            ...
                            <form className="flex flex-col gap-4 mt-6" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-2`}>
                                    ...
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            color={errors.pekerjaan?.message && "failure"}
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="pass" {...register("password")} helperText={errors.password?.message} color={errors.password?.message && "failure"} placeholder="password" />
                                    </div>
                                </div>
